...
export const Avatar = ({user}: {user:User}) => {
  ...
  if (avatar) {
    ...
    return (
      ...
      <path className="graphic-account__body" d="M12.5, 24a11044,11.44,0,0,0,7.77-2.94c-.5-2.71-3.73-4.8-7.66-4.8s-7.16,2.09-7.66,4
      .8A11.44,11.44,0,0,0,12.5,24Z"></path>
      </svg>
